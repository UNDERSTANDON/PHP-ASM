...
INSERT INTO threads (thread_id, forum_id, created_by, title)
VALUES (1, 1, 2, 'General discussion');

SELECT setval(pg_get_serial_sequence('threads', 'thread_id'), (SELECT COALESCE(MAX(thread_id), 1) FROM threads));
